...
<body>
<div style="color: white; text-align: center; font-size: 30px;">COMPLAITNS <i class="fas fa-archive"></i></div>
<%
...
<table id="customers">
          ...
          <th>EMAIL</th>
            ...
            <th scope="col">AGE</th>
            <th scope="col"><i class="fa fa-inr"></i>NATURE OF COMPLAINT</th>
            <th>DATE</th>
            <th>PLACE</th>
        ...
        ResultSet rs=st.executeQuery("select *from users inner join complaint");
       while(rs.next())
       {  
        %>
       <tr>
