...
<div style="color: black; text-align: center; font-size: 30px;">Film Shooting Permission<i class='fas fa-window-close'></i></div>
...
<div class="col-md-6">
 <label for="name" class="form-label">Name</label>
  ...
  <div class="col-md-6">
    <label for="Orgnizername" class="form-label">Director Name</label>
