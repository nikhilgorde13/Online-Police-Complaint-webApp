...
<div style="color: black; text-align: center; font-size: 30px;">Strike Request Permission<i class='fas fa-window-close'></i></div>
...
<div class="col-md-6">
 <label for="name" class="form-label">Name</label>
  ...
  <div class="col-6">
    <label for="typeofpermission" class="form-label">Strike Details</label>
