...
<title>Domastic Verfication</title>
</head>
<body>
...
<form action="DomasticAction.jsp" method="post">
<div style="color: black; text-align: center; font-size: 30px;">Domastic Verification<i class='fas fa-window-close'></i></div>
...
<div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="Ans" placeholder="if yes write Answer">
  </div>
 <div class="col-24">
