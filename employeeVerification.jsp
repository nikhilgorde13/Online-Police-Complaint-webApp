...
<title>Employee Verfications</title>
</head>
<body>
...
<form action="employeeVerificationAction.jsp" method="post">
<div style="color: black; text-align: center; font-size: 30px;">Employee Verification<i class='fas fa-window-close'></i></div>
