...
<form action="anynegligibleActioin.jsp" method="post">
<div style="color: black; text-align: center; font-size: 30px;">Any Negligible Complaint<i class='fas fa-window-close'></i></div>
