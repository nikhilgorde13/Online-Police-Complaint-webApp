...
<title>Character Certifications</title>
</head>
<body>
...
<form action="CharacterCertificationAction.jsp" method="post">
<div style="color: black; text-align: center; font-size: 30px;">Character Certification<i class='fas fa-window-close'></i></div>
