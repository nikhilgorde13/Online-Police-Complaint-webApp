...
<title>Divyang Complaints</title>
</head>
<body>
...
<form action="DivyangAction.jsp" method="post">

<div style="color: black; text-align: center; font-size: 30px;">Divyang Complaint<i class='fas fa-window-close'></i></div>
